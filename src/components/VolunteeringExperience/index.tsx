    ...
    >
      <div className="space-y-10">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-4xl font-bold gradient-text">{volunteering.heading}</h2>
        </motion.div>

        {/* Volunteering Experience Items */}
        <motion.div
          className="space-y-8"
              ...
              <div className="p-6">
                <div className="flex items-start space-x-4 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-lg font-semibold text-primary-600 mb-1">{item.event}</p>
