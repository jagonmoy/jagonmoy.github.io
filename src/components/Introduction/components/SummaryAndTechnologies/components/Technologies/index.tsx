    ...
    return (
      ...
      >
        ...
        <div className="flex-col space-y-4 ">
          ...
          <h1 className="font-bold text-gray-900 text-2xl">Technologies</h1>
          <div className="flex-col">
            <div className="flex flex-wrap gap-4 mt-4">
              ...
              />
              <img
                src="https://img.shields.io/badge/Material--UI-%230081CB.svg?style=for-the-badge&logo=material-ui&logoColor=white"
                alt="python"
              />
              <img
              ...
              />
              <img
                src="https://img.shields.io/badge/Playwright-%234144A1.svg?style=for-the-badge&logo=playwright&logoColor=white"
                alt="python"
              />
              <img
                src="https://img.shields.io/badge/React%20Testing%20Library-%23E33332.svg?style=for-the-badge&logo=testing-library&logoColor=white"
                alt="python"
              />
            </div>
            <div className="flex flex-wrap gap-4 mt-4">
              ...
              />
              <img
                src="https://img.shields.io/badge/Sequelize-%23161F26.svg?style=for-the-badge&logo=sequelize&logoColor=white"
                alt="python"
              />
            </div>
            <div className="flex flex-wrap gap-4 mt-4">
