...
function IndustryExperience() {
  ...
  const industryData = [
    {
      position: industry.experience1.position,
      company: industry.experience1.company,
      duration: industry.experience1.duration,
      bulletPoints: industry.experience1.bulletPoints,
      color: 'from-blue-500 to-cyan-600',
    },
    {
      position: industry.experience2.position,
      company: industry.experience2.company,
      duration: industry.experience2.duration,
      bulletPoints: industry.experience2.bulletPoints,
      color: 'from-purple-500 to-pink-600',
    },
    {
      position: industry.experience3.position,
      company: industry.experience3.company,
      duration: industry.experience3.duration,
      bulletPoints: industry.experience3.bulletPoints,
    ...
    >
      <div className="space-y-10">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-4xl font-bold gradient-text">{industry.heading}</h2>
        </motion.div>

        {/* Industry Experience Items */}
        <motion.div
          className="space-y-8"
              ...
              <div className="p-6">
                <div className="flex items-start space-x-4 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-lg font-semibold text-primary-600 mb-1">{item.company}</p>
